<script setup>
import { formatRupiah, formatClientTimezone } from '@/helpers/formatHelper.js';
    ...
    <div class="card flex flex-col gap-4 rounded-3xl p-6 bg-white">
        <div class="flex items-center justify-between">
            <p class="flex items-center gap-1">
                <img src="@/assets/images/icons/calendar-2-secondary-green.svg" class="flex size-[18px] shrink-0"
                    alt="icon">
                <span class="font-medium text-sm text-desa-secondary">{{ formatClientTimezone(item.created_at)
                }}</span>
            </p>
        ...
        <div class="flex items-center gap-6 justify-between">
            ...
            <div class="flex items-center gap-3 justify-end w-[252px] shrink-0">
                <RouterLink :to="{ name: 'socialAssistanceRecipientManage', params: { id: item.id } }"
