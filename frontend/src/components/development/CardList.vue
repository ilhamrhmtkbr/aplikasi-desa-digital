...
<template>
    <div class="card flex flex-col gap-6 rounded-3xl p-6 bg-white">
        <div class="flex items-center w-full">
            ...
            <RouterLink :to="{ name: 'developmentManage', params: { id: item.id } }"
        ...
        <div class="grid grid-cols-3 gap-3">
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="flex flex-col gap-1">
                    <p class="font-semibold text-lg leading-5 text-desa-dark-green">{{ formatClientTimezone(item.start_date) }}</p>
