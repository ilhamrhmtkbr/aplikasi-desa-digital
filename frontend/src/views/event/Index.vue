...
<template>
  ...
  <div id="Header" class="flex items-center justify-between">
    ...
    <router-link :to="{name:'eventAdd'}" class="flex items-center rounded-2xl py-4 px-6 gap-[10px] bg-desa-dark-green"
  ...
  <section id="TabButtons" class="w-full p-1 bg-desa-foreshadow rounded-full grid grid-cols-2 gap-3"
    ...
    <button type="button" data-content="My-applications" :class="['tab-btn', 'group', { active: filters.status === 'joined' }]">
      <div
          class="group-[.active]:bg-desa-dark-green group-[.active]:text-white rounded-full py-[18px] flex justify-center items-center"
