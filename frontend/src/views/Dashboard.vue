...
import {calculateAge, formatClientTimezone, formatRupiah} from "@/helpers/formatHelper.js";
...
const {data: familyMemberData, loading: loadingFamilyMember} = storeToRefs(familyMemberStore)
const {fetchAll: fetchFamilyMemberData} = familyMemberStore

const socialAssistanceRecipientStore = useSocialAssistanceRecipientStore()
const {data: socialAssistanceRecipientData, loading: loadingAssistanceRecipient} = storeToRefs(socialAssistanceRecipientStore)
const {fetchAll: fetchSocialAssistanceRecipient} = socialAssistanceRecipientStore

const eventParticipantStore = useEventParticipantStore()
const {data: eventParticipantData, loading: loadingEventParticipant} = storeToRefs(eventParticipantStore)
const {fetchAll: fetchSocialEventParticipant} = eventParticipantStore
    ...
    <div class="flex gap-[14px]">
      <div class="flex flex-col gap-[14px] shrink-0 w-[calc(463/1000*100%)]">
        <section id="Bantuan-Sosial" class="flex flex-col gap-6 p-6 gradient-vertical rounded-2xl">
          <img src="@/assets/images/icons/bag-orange-background.svg" alt="icon" class="size-[86px] shrink-0"/>
          <div class="flex flex-col gap-[12px]">
            <h2 class="font-medium text-sm leading-[17.5px] text-[#DEFF6E]">— Bantuan Sosial</h2>
            <h3 class="font-semibold text-2xl leading-[30px] text-white">Dari Desa Untuk Warga ❤️</h3>
            <p class="leading-6 text-white">Terima bantuan sosial dari desa yang tepat untuk kebutuhan spesifikmu setiap
              saat. 🫶🏻</p>
          </div>
          <router-link :to="{name:'socialAssistanceRecipient'}">
            <div class="flex items-center justify-between px-4 py-[18px] bg-white rounded-2xl">
              ...
              <img src="@/assets/images/icons/add-square-dark-green.svg" alt="icon" class="size-6 shrink-0"/>
            </div>
          </router-link>
        </section>
        <section id="Events-Joined" class="flex flex-col gap-6 p-6 bg-white rounded-2xl">
          <div class="flex items-center justify-between">
            <div class="flex flex-col gap-[6px]">
              <strong class="font-semibold text-[32px] leading-[40px]">{{ eventParticipantData.slice(0, 3).length }}</strong>
              <h2 class="font-medium leading-5 text-desa-secondary">Events Joined</h2>
            </div>
            <div class="p-[12px] rounded-full flex justify-center items-center bg-desa-foreshadow shrink-0">
          ...
          <div id="Recent-Event" class="flex flex-col gap-4">
            ...
            <div class="event py-4 rounded-2xl border border-desa-background flex flex-col gap-4"
              v-for="item in eventParticipantData.slice(0, 3)" :key="item.id">
              <div class="time px-4 flex items-center justify-between">
                <p class="font-medium text-sm leading-[17.5px] text-desa-secondary">{{ formatClientTimezone(item.created_at) }}</p>
              ...
              <div class="card px-4 flex items-center gap-3">
                <div class="flex items-center justify-center w-[100px] h-[80px] shrink-0 rounded-2xl overflow-auto">
                  <img :src="item.event?.thumbnail" alt="image"
                       class="w-full h-full object-cover"/>
                </div>
                <div class="flex flex-col gap-[6px] w-full">
                  <h4 class="font-semibold text-lg leading-[22.5px] line-clamp-1">{{ item.event?.name }}</h4>
                  <div class="flex items-center gap-1">
                    <img src="@/assets/images/icons/profile-2user-orange.svg" alt="icon" class="size-[18px] shrink-0"/>
                    <p class="font-semibold text-sm leading-[17.5px] text-desa-orange">{{ item.quantity }}</p>
                    <p class="font-semibold text-sm leading-[17.5px] text-desa-orange line-clamp-1">total partisipasi</p>
              ...
              <div class="harga-event px-4 flex items-center justify-between">
                ...
                <p class="font-medium leading-5 text-desa-red">Rp {{item.event?.price}}</p>
              </div>
            </div >
          </div>
        </section>
        <section id="Pembangunan" class="flex flex-col gap-6 p-6 bg-white rounded-2xl">
          ...
          <div id="Recent-Applicants" class="flex flex-col gap-4">
            ...
            <div class="applicant p-4 rounded-2xl border border-desa-background flex flex-col gap-4">
              <div class="flex items-center justify-between">
                <div class="flex items-center justify-center w-[100px] h-[80px] shrink-0 rounded-2xl overflow-hidden">
                  <img src="@/assets/images/thumbnails/kk-dashboard-3.png" alt="image" class="size-full shrink-0"/>
                </div>
              ...
              <div class="flex flex-col gap-1">
                <h5 class="font-semibold text-lg leading-[22.5px] line-clamp-1">Pembangunan Puskesmas Desa</h5>
              ...
              <div id="Tanggal-Pelaksanaan" class="flex items-center gap-[12px]">
                ...
                <div class="flex flex-col gap-1">
                  ...
                  <h6 class="font-medium text-sm leading-[17.5px] text-desa-secondary">Tanggal Pelaksanaan</h6>
                </div>
              </div>
              <hr class="border-desa-background"/>
              <div id="Waktu-Pelaksanaan" class="flex items-center gap-[12px]">
                ...
                <div class="flex flex-col gap-1">
                  ...
                  <h6 class="font-medium text-sm leading-[17.5px] text-desa-secondary">Waktu Pelaksanaan</h6>
                </div>
              </div>
            </div>
            <div class="applicant p-4 rounded-2xl border border-desa-background flex flex-col gap-4">
              <div class="flex items-center justify-between">
                <div class="flex items-center justify-center w-[100px] h-[80px] shrink-0 rounded-2xl overflow-hidden">
                  <img src="@/assets/images/thumbnails/kk-dashboard-4.png" alt="image" class="size-full shrink-0"/>
                </div>
              ...
              <div class="flex flex-col gap-1">
                <h5 class="font-semibold text-lg leading-[22.5px] line-clamp-1">Pembangunan Jalanan Utama</h5>
                <div class="flex gap-1">
                  <p class="font-medium leading-5 text-desa-secondary">Penanggung Jawab:</p>
                  <p class="font-semibold leading-5 text-desa-dark-green">Uzumaki Asep</p>
                </div>
              ...
              <hr class="border-desa-background"/>
              <div id="Tanggal-Pelaksanaan" class="flex items-center gap-[12px]">
                <div class="size-[52px] shrink-0 rounded-2xl bg-desa-foreshadow flex items-center justify-center">
                  <img src="@/assets/images/icons/calendar-2-dark-green.svg" alt="icon" class="size-6 shrink-0"/>
                </div>
                <div class="flex flex-col gap-1">
                  <p class="font-semibold leading-5 text-desa-dark-green">3 Jan 2025</p>
      ...
      <div class="flex flex-col gap-[14px] flex-1">
        <section id="Anggota-Keluarga" class="flex flex-col gap-6 p-6 bg-white rounded-2xl">
          <div class="flex items-center justify-between">
            <div class="flex flex-col gap-[6px]">
              <strong class="font-semibold text-[32px] leading-[40px]">{{ familyMemberData.length }}</strong>
              <h2 class="font-medium leading-5 text-desa-secondary">Anggota Keluarga</h2>
            </div>
            <div class="p-[16px] rounded-full flex justify-center items-center bg-desa-foreshadow shrink-0">
              <img src="@/assets/images/icons/profile-2user-dark-green.svg" alt="icon" class="size-6 shrink-0"/>
            </div>
          </div>
          <div class="box h-[1px] w-full"></div>
          <div class="people flex flex-col gap-[14px]" v-for="item in familyMemberData" :key="item.id">
            <div class="rounded-2xl border border-desa-background p-4 flex flex-col gap-6">
              <div class="flex items-center justify-between">
                <div class="flex items-center gap-[12px]">
                  ...
                  <div class="flex flex-col gap-[6px]">
                    <h4 class="font-semibold text-lg leading-[22.5px] line-clamp-1">{{ item.user?.name }}</h4>
                    <div class="flex items-center gap-1">
                      <img src="@/assets/images/icons/briefcase-secondary-green.svg" alt="icon"
                           class="size-[18px] shrink-0"/>
                      <p class="font-medium leading-5 text-desa-secondary line-clamp-1">{{ item.occupation }}</p>
                    </div>
                  </div>
                </div>
                <p class="font-medium leading-5">{{ calculateAge(item.date_of_birth)}} tahun</p>
              </div>
              <hr class="border-desa-foreshadow"/>
              <div class="flex items-center justify-between">
                <div class="flex items-center gap-1">
                  <img src="@/assets/images/icons/keyboard-secondary-green.svg" alt="icon"
                       class="size-[18px] shrink-0"/>
                  <p class="font-medium text-sm leading-[17.5px] text-desa-secondary">Nomor Induk Kependudukan:</p>
                </div>
                <p class="font-medium leading-5">{{item.identify_number}}</p>
              </div>
            </div>
          </div>
          <router-link :to="{name:'familyMember'}">
        ...
        <section id="Pengajuan-Bantuan-Sosial" class="flex flex-col gap-6 p-6 bg-white rounded-2xl">
          <div class="flex items-center justify-between">
            <div class="flex flex-col gap-[6px]">
              <strong class="font-semibold text-[32px] leading-[40px]">{{socialAssistanceRecipientData.length}} Pengajuan</strong>
              <h2 class="font-medium leading-5 text-desa-secondary">Bantuan Sosial</h2>
            </div>
            <div class="p-[16px] rounded-full flex justify-center items-center bg-desa-foreshadow shrink-0">
              <img src="@/assets/images/icons/note-dark-green.svg" alt="icon" class="size-6 shrink-0"/>
            </div>
          </div>
          <div class="box h-[1px] w-full"></div>
          <div class="people flex flex-col gap-4">
            <h3 class="font-medium leading-5 text-desa-secondary">Recent Bansos</h3>
            <div class="bantuan p-4 rounded-2xl border border-desa-background flex flex-col gap-4" v-for="item in socialAssistanceRecipientData.slice(0, 3)" :key="item.id">
              <div class="flex items-center justify-between">
                <p class="font-medium text-sm leading-[17.5px] text-desa-secondary">{{formatClientTimezone(item.created_at)}}</p>
                <img src="@/assets/images/icons/calendar-2-secondary-green.svg" alt="icon"
                     class="size-[18px] shrink-0"/>
              ...
              <hr class="border-desa-background"/>
              <h4 class="font-semibold text-lg leading-[22.5px]">{{item.name}}</h4>
              <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                  <div class="size-[52px] shrink-0 rounded-2xl flex justify-center items-center bg-desa-foreshadow">
                    <img src="@/assets/images/icons/money-dark-green.svg" alt="icon" class="size-6 shrink-0"/>
                  </div>
                  <div class="flex flex-col gap-[6px]">
                    <h5 class="font-semibold text-lg leading-[22.5px]">Rp {{formatRupiah(item.amount)}}</h5>
                    <p class="font-medium text-sm leading-[17.5px] text-desa-secondary">Nominal Pengajuan</p>
                  </div>
                </div>
        ...
        <section id="Unduh-Rumah-Tangga-Stat"
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="flex flex-col gap-[6px]">
              <h2 class="font-medium text-sm leading-[17.5px] text-desa-lime">— Unduh Rumah Tangga Stat</h2>
              <strong class="font-semibold text-2xl leading-[30px] text-white">Statistik Rumah Tangga</strong>
            </div>
          </div>
          <button type="button" class="flex items-center justify-between px-4 py-[18px] bg-white rounded-2xl">
            <p class="font-medium leading-5 text-desa-dark-green">Download Laporan</p>
            <img src="@/assets/images/icons/receive-square-dark-green.svg" alt="icon" class="size-6 shrink-0"/>
          </button>
        </section>
      </div>
    </div>
