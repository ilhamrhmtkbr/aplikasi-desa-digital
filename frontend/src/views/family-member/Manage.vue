    ...
    <div class="shrink-0 rounded-3xl p-6 bg-white flex flex-col gap-6 h-fit w-[calc(520/1000*100%)]">
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
          ...
          <div class="flex flex-col gap-[6px]">
            <h3 class="font-semibold text-xl leading-[25px]">{{ data.user?.name }}</h3>
            <div class="flex items-center gap-1">
              <img src="@/assets/images/icons/briefcase-secondary-green.svg" alt="icon" class="size-[18px] shrink-0" />
              <p class="font-medium text-sm leading-[17.5px] text-desa-secondary">{{ data?.occupation }}</p>
            </div>
          </div>
        </div>
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex flex-col gap-1">
          <p class="font-semibold text-lg leading-[22.5px]">{{ data?.identify_number }}</p>
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex flex-col gap-1">
          <p class="font-semibold text-lg leading-[22.5px]">{{ calculateAge(data?.date_of_birth) }} Tahun</p>
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex flex-col gap-1">
          <p class="font-semibold text-lg leading-[22.5px]">{{ data?.date_of_birth }}</p>
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex flex-col gap-1">
          <p class="font-semibold text-lg leading-[22.5px]">{{ data?.gender }}</p>
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex flex-col gap-1">
          <p class="font-semibold text-lg leading-[22.5px]">{{ data?.user?.email }}</p>
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex flex-col gap-1">
          <p class="font-semibold text-lg leading-[22.5px]">{{data?.phone_number}}</p>
